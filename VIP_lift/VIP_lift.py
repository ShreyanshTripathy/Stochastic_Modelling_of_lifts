...
class VIPLiftSystem:
    ...
    def __init__(self, current_floor, num_floors, current_time, filepath, Passenger_limit, floor_to_Serve):
...
elevator = VIPLiftSystem(current_floor=0, num_floors=5, current_time=0, filepath="dummy", Passenger_limit=8, floor_to_Serve=3)
...
elevator.run_simulation(passenger_data)
