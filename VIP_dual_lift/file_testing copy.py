...
class VIPDualSystem:
    ...
    def __init__(self, current_floor_A,current_floor_B, num_floors,filepath, Passenger_limit, floor_to_serve, current_time = 0):
...
elevator = VIPDualSystem(0,0, 5, "file_testing%20copy.csv", 8, 3)
