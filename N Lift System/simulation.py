...
def generate_and_process_data(l, file_path, duration, current_floors, passenger_limit, num_floors,number_of_lifts, current_timestamp=0):
    ...
    try:
        ...
        permission = input(f"Do you want to continue for {number_of_lifts} lifts?\n")
        if permission.lower() == "yes":
            elevator = NLiftSystem(
...
def run_multiple_scenarios():
    ...
    traffic_levels = {
        # "low_traffic": {20: [0.00001] + [0.00005] * 20},
        # "moderate_traffic": {20: [0.005] + [0.002] * 20},
        "high_traffic": {  20: [0.1] + [0.05] * 20 }
    }
    ...
    for traffic_level, floor_configs in traffic_levels.items():
        ...
        for num_floors, l in floor_configs.items():
            ...
            current_floors = [random.randint(0, num_floors) for _ in range(number_of_lifts)]  # Initial positions of four lifts
