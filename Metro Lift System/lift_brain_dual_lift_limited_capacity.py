...
class DualLiftBrain:
    def __init__(self, liftAfloor, liftBfloor, num_floors, passenger_limit, filepath, current_time=0, directionA=0, directionB=0, lowest_floor=0, lift_speed=0.89408, building_height=20):
        self.liftAfloor = liftAfloor
        self.liftBfloor = liftBfloor
        ...
        self.current_floor_lift_A = liftAfloor
        self.current_floor_lift_B = liftBfloor
