...
class Elevator_varied_passenger_arrival_time:
    ...
    def __init__(self, current_floor, num_floors, current_time, filepath, Passenger_limit,threshold_density):
    ...
    def run_simulation(self, passenger_data):
        ...
        while self.threshold_density>current_density:
        ...
        return passenger_data, self.orders_done