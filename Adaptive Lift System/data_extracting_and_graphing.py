...
class DataExtractingAndGraphing:
    def __init__(self, completed_data, csv_file_name, num_of_floors):
    ...
    def plot_data(self):
        ...
        stats_file_name = f"{timestamp}_{number_passengers}passengers_{self.number_of_floors}floors.txt"
        ...
        graph_file_prefix = f'{timestamp}_np{number_passengers}_nf{self.number_of_floors}'
        ...
        plt.grid(True)
        plt.savefig(f'Graphs/{graph_file_prefix}_normalized_histogram_waiting_times.png')
        ...
        plt.savefig(f'Graphs/{graph_file_prefix}_waiting_time_vs_number_of_people_ranged.png', bbox_inches='tight')
        ...
        plt.ylabel('Number of People')
        plt.grid(axis='y', linestyle='--', alpha=0.7)
        plt.savefig(f'Graphs/{graph_file_prefix}_waiting_time_vs_number_of_people.png')
        ...
        plt.ylabel('Density (Probability per unit time)')
        plt.grid(True)
        plt.savefig(f'Graphs/{graph_file_prefix}_normalized_histogram_total_service_times.png')
        ...
        plt.tight_layout()
        # plt.show()
        plt.savefig(f'Graphs/{graph_file_prefix}_heatmap_passenger_arrivals.png')
        ...
        plt.grid(True)
        plt.savefig(f'Graphs/{graph_file_prefix}_waiting_time_each_passenger.png')
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(f'Graphs/{graph_file_prefix}_waiting_time_kde.png')
        ...
        plt.ylabel('Floors')
        plt.grid(True)
        plt.savefig(f'Graphs/{graph_file_prefix}_heatmap_passenger_arrivals_2.png')
        ...
        plt.ylabel('Density (Probability per unit time)')
        plt.grid(True)
        plt.savefig(f'Graphs/{graph_file_prefix}_normalized_histogram_waiting_times_2.png')
        ...
        plt.ylabel('Density (Probability per unit time)')
        plt.grid(True)
        plt.savefig(f'Graphs/{graph_file_prefix}_normalized_histogram_total_service_times_2.png')
